...
let todoArray = [
  ...
  function renderTopInputSectionInDOM() {
    const addTaskDiv = document.querySelector('.add-items');  
    
    addTaskDiv.innerHTML = `
    <input
    type="text"
    class="todo-list-input form-control"
  ...
  let editCategoriesBtn = document.getElementsByClassName('categories-btn');
